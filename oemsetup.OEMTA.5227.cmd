...
set oobeUpdateCmd="%COMMONPROGRAMFILES%\Microsoft Shared\ClickToRun\OfficeC2RClient.exe"
...
reg add "%uoRegPath%" /f /t REG_EXPAND_SZ /v %oobeUpdateCmdKey% /d %oobeUpdateCmd%
reg add "%uoRegPath%" /f /t REG_SZ /v %oobeUpdateArgsKey% /d %oobeUpdateArgs%
reg add "%uoRegPath%" /f /t REG_SZ /v %oobeUpdateMetadataKey% /d %oobeUpdateMetadata%

set c2rRegPath=%TEMPREGISTRY%\Microsoft\Office\ClickToRun
set c2rOobeKey="OOBEExpress"
set c2rOobe="true"

reg add "%c2rRegPath%" /f /t REG_SZ /v %c2rOobeKey% /d %c2rOobe%
